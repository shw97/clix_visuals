...
var color = d3.scale.ordinal()
    .range(["#00FA9A", "#3366cc", "#dc3912", "#ff9900", "#109618", "#990099", "#9ACD32", "#3CB371", "#FF4500", "#00008B","#BA55D3", "#00BFFF", "#4B0082", "#FF1493", "#696969", "#316395", "#0099c6", "#dd4477", "#66aa00", "#b82e2e", "#316395"])
...
d3.csv("data/mz_progress_num_users_viz_top50.csv", function(error, data) {
  ...
  svg.append('text')
      ...
      .attr("y",   80)
      .style("text-anchor", "middle")
      .text("(for top 50 schools of Mizoram)")
      .style("font-size", "18px")
      .style("fill", 'darkblue')
